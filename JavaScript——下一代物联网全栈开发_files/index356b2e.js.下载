...
});define("appmsg/index.js",["biz_common/utils/string/html.js","biz_wap/jsapi/a8key.js","biz_wap/utils/device.js","biz_common/dom/class.js","appmsg/log.js","biz_wap/utils/ajax.js","biz_common/dom/attr.js","appmsg/max_age.js","biz_wap/utils/mmversion.js","appmsg/test.js","biz_common/dom/event.js","page/appmsg/page_mp_article_improve_combo.css","page/appmsg/not_in_mm.css","biz_common/utils/url/parse.js","appmsg/cdn_img_lib.js","appmsg/share.js","biz_common/log/jserr.js","biz_wap/ui/lazyload_img.js","appmsg/async.js","appmsg/copyright_report.js","biz_wap/jsapi/core.js","appmsg/outer_link.js","appmsg/review_image.js","appmsg/iframe.js","appmsg/qqmusic.js","appmsg/voice.js","appmsg/weapp.js","appmsg/wxtopic.js","appmsg/cdn_speed_report.js","appmsg/page_pos.js","appmsg/report_and_source.js","appmsg/report.js","appmsg/fereport.js","biz_wap/safe/mutation_observer_report.js","sougou/index.js"],function(e){
"use strict";
function t(){
function t(e,t){
var o={
...
var x=-1!=navigator.userAgent.indexOf("TBS/"),I=function(e,o){
t(e,function(e,t){
...
I("lossy",e),I("lossless",e),I("alpha",e),I("animation",e);
};
window.webp=!1,j(function(t){
function o(e){
...
var i=e.__retryload;
return i=0,t=t.https2http(),e.__retryload=i,e.src=A.addParam(t,"retryload",i,!0),
e.clickRetry=1,!1;
};
l.on(e,"click",i);
}
...
var m,g,w=e.clientWidth,_=e.clientHeight,u=i.backgroundOrigin,f=i.backgroundImage.slice(4,-1).replace(/"/g,""),h=parseFloat(i.paddingLeft),A=parseFloat(i.borderLeftWidth),y=parseFloat(i.paddingRight),v=parseFloat(i.borderRightWidth),b=parseFloat(i.paddingTop),x=parseFloat(i.borderTopWidth),I=parseFloat(i.paddingBottom),j=parseFloat(i.borderBottomWidth),E=parseFloat(i.marginTop),R=parseFloat(i.marginLeft);
"padding-box"===u?(m=A+R,g=x+E):"border-box"===u?(w+=A+v,_+=x+j,m=R,g=E):"content-box"===u&&(w-=y+h,
_-=b+I,m=A+R+h,g=x+E+b);
var z;
if(a.indexOf("%")>=0){
...
var B=k+g+c,S=z+m;
S=Math.max(S,R),B=Math.min(B,_+5+g),S+=10,B-=35,t.style.top=B+"px",t.style.left=S+"px";
var O="click",K=function(){
if(t){
...
t&&(t.children.item(1).style.display="none",l.off(t,O,K),t=null),e.style.backgroundImage='url("'+i+'")',
e.loadGif=!0;
},o.onerror=function(){
...
l.on(window,"load",I),setTimeout(function(){
I();
},1e4),function(){
...
window.__addIdKeyReport("28307",89+1*o)),u>o&&(o++,t.__retryload=o,1==o&&e.indexOf("http://")>-1?(e=e.http2https(),
window.__addIdKeyReport("28307",60),window.__addIdKeyReport("28307",77)):1==o&&e.indexOf("https://")>-1&&(e=e.https2http(),
window.__addIdKeyReport("28307",61),window.__addIdKeyReport("28307",70)),t.start_load_time=+new Date,
t.src=A.addParam(e,"retryload",o,!0)),window.__has_imgfailed||(window.__has_imgfailed=!0,
window.__addIdKeyReport("28307",65)),1==t.clickRetry&&window.__addIdKeyReport("28307",68),
...
var E=e("appmsg/copyright_report.js"),R=e("biz_wap/jsapi/core.js");
!function(){
...
-1!=navigator.userAgent.indexOf("WindowsWechat")||-1!=navigator.userAgent.indexOf("Mac OS")?location.href=t:R.invoke("openUrlWithExtraWebview",{
url:t,
openType:1
},function(e){
...
location.href.match(/fontScale=\d+/)&&y.isIOS&&R.on("menu:setfont",function(e){
...
var q=e("appmsg/review_image.js"),k=document.getElementById("js_cover"),B=[];
k&&B.push(k),new q({
container:document.getElementById("js_content"),
...
var m=top.window.user_uin||0,g=Math.floor(m/100)%1e3,w=0!==m&&1001>g;
o.config({
